 ...
 */
    ...
    */
    ...
    public static void actualizarPuntos(Persona[]personas,Ronda[]rondas,int puntosConfig,int cantPartidos){
        for(int i=0;i<personas.length;i++){
            for(int j=0;j<rondas.length;j++){
                personas[i].contarPuntos(rondas[j],puntosConfig,cantPartidos,"Francia");
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        //CALCULAR CANTIDAD DE PERSONAS DENTRO DE LA BASE DE DATOS
        ...
        if (rondas != null){
            ...
            //ACTUALIZO LOS PUNTOS , EL PARAMETRO QUE MANDO POR NUMERO SON LOS PUNTOS CONFIGURABLES POR ACIERTO EN ESTE CASO MANDO 2
            TrabajoIntegrador.actualizarPuntos(personas, rondas,2,cantidadPartidos);
            //IMPRIMO PUNTOS
